...
> **⚠️ 每一页都必须有重点色词！这是视觉连贯性的核心！**

| 页面类型 | 高亮要求 | 示例 |
|----------|---------|------|
| **封面** | **必须 2 个**（主标题1个 + 标语1个） | 主：`<span class="highlight">体验</span>`<br>标语：`<span class="highlight">经历</span>` |
| **内容页** | **必须 1-2 个** | `<span class="highlight">随时抽身离开</span>` |
| **总结页** | **必须 1 个** | `<span class="highlight">用笑容掩饰脆弱</span>` |

**🎯 选词策略：**
- 封面：主标题和标语的高亮词应形成**语义呼应**（对比/递进/因果）
- 内容页：选择**情感核心词**或**转折词**，而非主题词
- 总结页：与封面高亮词形成**首尾呼应**

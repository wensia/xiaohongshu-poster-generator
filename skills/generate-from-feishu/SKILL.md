...
> **⚠️ 每一张内容页都必须有重点色词！没有重点色的页面视为不合格！**

**内容页必须包含至少 1 个重点色词，与封面形成视觉呼应！**

| 位置 | 要求 | 样式 |
|------|------|------|
| 正文中 | **必须**包含 1-2 个 | `<span class="accent">词</span>` 或 `<span class="highlight">词</span>` |
| 引用/金句 | 可选 0-1 个 | 同上 |
...
| 内容类型 | 选择策略 | 示例 |
|----------|----------|------|
| 转折句 | 标记转折后的核心词 | "好，那就<span class="accent">不去了</span>" |
| 情感句 | 标记情感词 | "花在<span class="accent">体验</span>上不亏" |
| 观点句 | 标记核心观点 | "射手座花钱讲究<span class="accent">爽</span>" |
...
```html
<div class="content-text">
  <p>射手座花钱讲究一个<span class="accent">「爽」</span>字</p>
  <p>不太在乎贵不贵</p>
  <p>在乎的是这个钱花得<span class="accent">值不值</span></p>
</div>
<!-- 两个重点色词形成呼应 -->
```
